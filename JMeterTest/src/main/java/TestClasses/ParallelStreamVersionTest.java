...
import ufrn.ParallelStreamKnnClassifier;

public class ParallelStreamVersionTest extends AbstractJavaSamplerClient implements Serializable {
	@Override 
	public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        ParallelStreamKnnClassifier knn = new ParallelStreamKnnClassifier(Integer.valueOf(k), Integer.valueOf(train_instances), Integer.valueOf(test_instances), Integer.valueOf(test_limit));
