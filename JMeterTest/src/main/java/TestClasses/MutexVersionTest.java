...
import ufrn.MutexKnnClassifier;


public class MutexVersionTest extends AbstractJavaSamplerClient implements Serializable {
	@Override 
	public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
		...
		MutexKnnClassifier knn = new MutexKnnClassifier(Integer.valueOf(k), Integer.valueOf(train_instances), Integer.valueOf(test_instances), Integer.valueOf(test_limit), Integer.valueOf(n_threads));
