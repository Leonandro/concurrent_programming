...
import ufrn.CallableKnnClassifier;

public class CallableVersionTest extends AbstractJavaSamplerClient implements Serializable {
	@Override 
	public SampleResult runTest(JavaSamplerContext javaSamplerContext)  {
		...
		CallableKnnClassifier knn = new CallableKnnClassifier(Integer.valueOf(k), Integer.valueOf(train_instances), Integer.valueOf(test_instances), Integer.valueOf(test_limit), Integer.valueOf(n_threads));
