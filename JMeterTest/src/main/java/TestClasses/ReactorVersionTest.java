...
import ufrn.ReactorKnnClassifier;

public class ReactorVersionTest extends AbstractJavaSamplerClient implements Serializable {
	@Override 
	public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
		...
		ReactorKnnClassifier knn = new ReactorKnnClassifier(5, 7526883, 1742866, 500, 2);
